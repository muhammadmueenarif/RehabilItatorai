...
# GHL Contact Creation Test Script
# This script creates a test contact in GoHighLevel
...
echo "Making API request to create contact..."
...
echo ""
echo "Contact creation test completed!"
